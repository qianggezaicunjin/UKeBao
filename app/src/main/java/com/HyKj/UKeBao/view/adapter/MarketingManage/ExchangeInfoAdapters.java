...
public class ExchangeInfoAdapters extends MyBaseAdapter<ProductLists> {
	...
	public ExchangeInfoAdapters(Context context, List<ProductLists> list, Double infacPrice) {
		super(context, list);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		mHolder.goodsCount.setText("X"+rowList.get(position).getProductAmount());
